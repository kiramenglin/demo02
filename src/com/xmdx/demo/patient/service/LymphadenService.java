...
@Service(name="patient.lym")
public class LymphadenService extends BusinessServices {
	//功能号
	private static final String authFuncNo = "patient.lym";
	//表名
	...
	public int init(ActionContext ac) throws Exception {
		...
		ac.setStringValue(CONST_FORMNAME, "com/xmdx/demo/lymphaden_test.html");		
