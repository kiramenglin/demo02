...
@Service(name="patient.vein")
public class VeinService extends BusinessServices {
	//功能号
	private static final String authFuncNo = "patient.vein";
	//表名
	...
	public int init(ActionContext ac) throws Exception {
		...
		ac.setStringValue(CONST_FORMNAME, "com/xmdx/demo/patient/vein_test.html");		
