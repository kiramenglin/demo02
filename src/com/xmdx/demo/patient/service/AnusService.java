...
@Service(name="patient.anus")
public class AnusService extends BusinessServices {
	//功能号
	private static final String authFuncNo = "patient.anus";
	//表名
	...
	public int init(ActionContext ac) throws Exception {
		...
		ac.setStringValue(CONST_FORMNAME, "com/xmdx/demo/patient/anus_test.html");		
