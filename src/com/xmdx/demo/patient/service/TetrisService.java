...
@Service(name="patient.tetris")
public class TetrisService extends BusinessServices {
	//功能号
	private static final String authFuncNo = "patient.tetris";
	//表名
	...
	public int init(ActionContext ac) throws Exception {
		...
		ac.setStringValue(CONST_FORMNAME, "com/xmdx/demo/patient/tetris.html");		
