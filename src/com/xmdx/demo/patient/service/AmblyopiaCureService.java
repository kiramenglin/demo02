...
@Service(name="patient.amb")
public class AmblyopiaCureService extends BusinessServices {
	//功能号
	private static final String authFuncNo = "patient.amb";
	//表名
	...
	public int init(ActionContext ac) throws Exception {
		...
		ac.setStringValue(CONST_FORMNAME, "com/xmdx/demo/patient/amblyopia_cure.html");		
