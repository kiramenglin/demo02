...
public class UserService extends BusinessServices {
	...
	public int delete(ActionContext ac) throws Exception {
		...
		String uidStr = ac.getHttpRequest().getParameter("U_ID");
	...
	public int goTo(ActionContext ac) throws Exception {
		...
		String uid = ac.getHttpRequest().getParameter("U_ID");
		if (StringUtils.isNotEmpty(uid)) {
			...
			if(pos.length == 0) {
				ac.setErrorContext("您所选择的用户已被删除！");
		...
		ac.setStringValue("FORMNAME", "com/xmdx/demo/back/user_edit.html");
