...
@Service(name="doctor.password")
public class DoctorPasswordService extends BusinessServices {
	private static final String authFuncNo = "doctor.password";
	...
	public int init(ActionContext ac) throws Exception {
		...
		ac.setStringValue(CONST_FORMNAME, "com/xmdx/demo/doctor/doctor_password.html");		
